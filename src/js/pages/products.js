...
function initProducts() {
  ...
  if (categoryField) categoryField.innerHTML = categoryOptionsMarkup(enabledCategories);
  const requestedCategory = params.get('category');
  if (requestedCategory && !enabledCategories.some(({ id }) => id === requestedCategory)) params.delete('category');
...
if (typeof document !== 'undefined') initProducts();
